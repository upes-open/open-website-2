    ...
    <footer className='w-full bg-[#181818] text-gray-200 pt-8 pb-4 px-4 sm:px-12'>
      <div className='max-w-6xl mx-auto flex flex-col sm:flex-row justify-between gap-8 pb-6'>
        ...
        <div className='flex-1 min-w-[220px]'>
          <div className='flex items-center gap-3 mb-2'>
            <div className='bg-white text-black rounded-md w-10 h-10 flex items-center justify-center font-bold text-lg font-mono'>
              OU
            </div>
          ...
          <div className='flex gap-3 mt-2'>
            {/* TODO: Use lucide-react or react-icons instead of inline SVGs */}
            <Link
      ...
      <div className='max-w-6xl mx-auto flex flex-col items-center'>
        <div className='text-xs text-gray-400 mb-2 font-mono'>
          &copy; 2025 OPEN COMMUNITY UPES. All rights reserved.
        </div>
      </div>
    </footer>
  );
